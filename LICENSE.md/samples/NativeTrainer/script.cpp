...
void draw_rect(float A_0, float A_1, float A_2, float A_3, int A_4, int A_5, int A_6, int A_7)
{
	...
	drawText("                                 Weclome To ~o~Halloween ~w~By ~g~The Crusader, ~w~enjoy!!", 1, 0.45, 0.132f, 0.50f, 0.40f, titleTextRed, titleTextGreen, titleTextBlue, titleTextOpacity, true);
	drawText("~o~Halloween", 7, 0.50, 0.09f, 0.75f, 0.75f, titleTextRed, titleTextGreen, titleTextBlue, titleTextOpacity, true);
